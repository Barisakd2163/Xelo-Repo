...
//            Log.d("xelo_$name", "vServer = ${vServer}")
            val vName = video.attr("data-name")
//            Log.d("xelo_$name", "vName = ${vName}")
...
//                Log.d("xelo_$name", "turkvearab url = ${url}")
                loadExtractor(url, "${mainUrl}/", subtitleCallback, callback)
            }
        }
