//Bu araç @xelo tarafından | xelo-repo için yazılmıştır!
...
open class ReklamSiker : ExtractorApi() {
    ...
    override suspend fun getUrl(
        ...
        if (url.contains("tuberep_")){
            ...
            Log.d("xelo_${this.name}","video = $video")
        ...
        Log.d("xelo_${this.name}","farkli geldi")
        ...
        Log.d("xelo_${this.name}","iframeSon = $iframeSon")
